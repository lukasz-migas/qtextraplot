...
class QtViewerNapari(_QtViewer):
    """Viewer widget for napari."""
...
#             autoswap=True,
#         )
#         self.canvas.events.mouse_double_click.connect(self._on_handle_mouse_double_click)
#         self.viewer.layers.events.inserted.connect(self._on_add_layer_change)
#         self.viewer.events.theme.connect(self.canvas._on_theme_change)
#
#     def _on_handle_mouse_double_click(self, event):
