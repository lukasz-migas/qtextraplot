...
def main() -> int:
    ...
    line_view.widget.setWindowTitle("qtextraplot vispy backend: line")
    line_view.widget.resize(900, 500)
    line_view.widget.show()
    ...
    scatter_view.widget.setWindowTitle("qtextraplot vispy backend: scatter")
    scatter_view.widget.resize(900, 500)
    scatter_view.widget.show()
